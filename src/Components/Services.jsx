    ...
    <section class="duration-300 overflow-hidden pb-10" id="service">
      <div class="py-8 px-4 mx-auto max-w-screen-xl sm:py-16 lg:px-6 relative">
        <div class="container py-3 px-4 pb-8">
          <h1
            data-aos="zoom-in"
            className="text-2xl sm:text-4xl font-bold max-w-[650px] mx-auto text-center font-curcise"
          >
            Our Services
          </h1>
        </div>
        ...
        <div className="h-[300px] w-[300px] bg-gradient-to-r from-primary to-secondary rounded-full absolute bottom-[420px] left-[1170px] blur-3xl opacity-50 "></div>
        <div className="h-[300px] w-[300px] bg-gradient-to-r from-primary to-secondary rounded-full absolute bottom-[-150px] left-[-250px] blur-3xl opacity-50 "></div>
      </div>
    </section>
  );
}
